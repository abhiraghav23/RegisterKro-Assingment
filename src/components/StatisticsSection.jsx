...
const StatisticsSection = () => {
  ...
  return (
    <div className="bg-white py-16 px-4">
      ...
      <h2 className="text-yellow-500 text-sm tracking-wide uppercase font-bold">WHY REGISTER KARO</h2>
        <h3 className="text-gray-900 text-2xl font-bold mb-8">Some Numbers are important</h3>
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8">
          {stats.map((stat, index) => (
            <div key={index} className="text-center">
              <p className="text-4xl font-bold mb-2 bg-gradient-to-tl from-[#bd883d] to-[#1c4670] text-transparent bg-clip-text">{stat.value}</p>
